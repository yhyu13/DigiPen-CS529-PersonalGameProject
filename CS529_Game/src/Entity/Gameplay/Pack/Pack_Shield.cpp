#include "Pack_Shield.hpp"
#include "src/Platform/Win32_SDL/WinSDLAudioManager.hpp"

int My::Entity::Pack_Shield::Tick(double deltaTime)
{
...
int My::Entity::Pack_Shield::Draw()
{
...
void My::Entity::Pack_Shield::OnComponentHit(std::weak_ptr<Event> e)
{
	...
	{
		SetGCToTrue();
		g_pAudioManager->PlayChunck("EnableShield");
	}
}
